...
public class DiceSet {
  ...
  public static void main(String[] args) {
    ...
    while (diceSet.getCurrent(0) != 6 || diceSet.getCurrent(1) != 6 || diceSet.getCurrent(2) != 6 ||
      ...
      if (diceSet.getCurrent(0) != 6){
        diceSet.reroll(0);
      }else if (diceSet.getCurrent(1) != 6){
        diceSet.reroll(1);
      }else if (diceSet.getCurrent(2) != 6){
        diceSet.reroll(2);
      }else if (diceSet.getCurrent(3) != 6){
        diceSet.reroll(3);
      }else if (diceSet.getCurrent(4) != 6){
        diceSet.reroll(4);
      }else if (diceSet.getCurrent(5) != 6){
        diceSet.reroll(5);
      }
      System.out.println(diceSet.getCurrent());
    }
